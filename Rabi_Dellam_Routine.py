...
num_k = 4
sym_breaking = True #Still have to add symmetry breaking to JC; for Rabi set the kind of symmetry  breaking below
#System Properties
omega = 1
vib = 20
...
if tested_delta_only:
    ...
    single_del_file_name = os.path.join("Single_Del_Cross_Sections", f"{datetime.today().strftime('%Y-%m-%d')}_vib={vib}_dellam_scan_{model}_{sparse_mode}_{extend}")
